...
const styles = StyleSheet.create({
  ...
  content: { flexGrow: 1, paddingHorizontal: 22, paddingTop: 24, paddingBottom: 40 },
  ...
  selfieTextBox: { flex: 1, minWidth: 0 },
  ...
  infoText: { flex: 1, minWidth: 0, color: COLORS.muted, fontSize: 14, lineHeight: 22, fontWeight: '700' },
  ...
  confirmText: { flex: 1, minWidth: 0, color: COLORS.muted, fontSize: 14, lineHeight: 22, fontWeight: '700' },
