...
function getGateMeta(currentUserPhase: IdentityPhase) {
  if (currentUserPhase === 'verified') {
    return {
      ...
      color: '#4A9A65',
      borderColor: 'rgba(74,154,101,0.30)',
      backgroundColor: 'rgba(74,154,101,0.08)',
  ...
  if (currentUserPhase === 'in_review') {
    return {
      ...
      color: '#8FA3B8',
      borderColor: 'rgba(143,163,184,0.36)',
      backgroundColor: 'rgba(143,163,184,0.11)',
  ...
  return {
    ...
    color: '#B85C5C',
    borderColor: 'rgba(184,92,92,0.36)',
    backgroundColor: 'rgba(184,92,92,0.11)',
...
const styles = StyleSheet.create({
  ...
  blockedReasonCard: {
    ...
    borderRadius: 18,
    borderWidth: 1,
    borderColor: 'rgba(184,92,92,0.28)',
  ...
  blockedReasonCardReview: {
    borderColor: 'rgba(143,163,184,0.34)',
    backgroundColor: 'rgba(143,163,184,0.09)',
  },
